...
strings[50] = "W2-L18 You'll need to stay in white color and avoid other colors to progress!"
...
strings[181] = "TUTORIAL-L5 Every challenge has few levels, however the [c_red]progress won't be saved if you leave the\nsession,[/] keep this in mind, because you will have to beat the challenge in one go."
