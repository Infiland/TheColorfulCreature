...
spritedistance = -global.multiplayerplayerhat[global.multiplayerplayerconfigchoose - 1] * 120
...
for (var i = 0; i < global.MU_hat_count; i++) {
	var _xpos = 455 + i * 120 + realspritedistance
	if (i > 0 && global.hat[i] < 1) {
		draw_sprite(s_lockedhaticon,0,_xpos,205)
	} else {
		draw_sprite(global.MU_hat_sprite[i],0,_xpos,205)
	}
}
