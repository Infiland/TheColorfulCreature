...
image_alpha = 0
depth = -15001
req = 20 //Change this so that news can appear

// Full-screen hitbox to block underlying mouse events (same as o_popup)
x = 0
y = 0
...
text = "Release 1.2.0 is here! [rainbow][wave]STEAM WORKSHOP[/] has arrived! You can now browse, play and share custom levels and challenges with the community!\n\nAlso added [c_yellow]Online Multiplayer[/], an in-game News Viewer, Steam Rich Presence, and tons of language updates!\n\nHave Fun!"
