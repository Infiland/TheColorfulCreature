...
if steam_get_achievement("FLAG_GUY") { allach += 1 }
...
if steam_get_achievement("THE_CROWN") { allach += 1 }
...
if steam_get_achievement("EASTEREGG_3") { allach += 1 }
if steam_get_achievement("EASTEREGG_4") { allach += 1 }
if steam_get_achievement("WORLD_WIDE_WEB") { allach += 1 }
...
if steam_get_achievement("TUTORIAL_CHALLENGE") { allach += 1 }
if steam_get_achievement("LADDER_CHALLENGE") { allach += 1 }
if steam_get_achievement("INVISIBLE_CHALLENGE") { allach += 1 }
if steam_get_achievement("BIGROOM_CHALLENGE") { allach += 1 }
if steam_get_achievement("SLIPPERY_CHALLENGE") { allach += 1 }
if steam_get_achievement("DOUBLEJUMP_CHALLENGE") { allach += 1 }
if steam_get_achievement("BLIND_CHALLENGE") { allach += 1 }
if steam_get_achievement("TROOP_CHALLENGE") { allach += 1 }
if steam_get_achievement("SPEED_CHALLENGE") { allach += 1 }
if steam_get_achievement("WATER_CHALLENGE") { allach += 1 }
if steam_get_achievement("MOVING_CHALLENGE") { allach += 1 }
if steam_get_achievement("BREAKABLE_CHALLENGE") { allach += 1 }
if steam_get_achievement("SPIKE_CHALLENGE") { allach += 1 }
if steam_get_achievement("COMMUNITY_CHALLENGE") { allach += 1 }
if steam_get_achievement("CORRUPTED_SPIKE_CHALLENGE") { allach += 1 }
if steam_get_achievement("WORKSHOP_BEGINNER") { allach += 1 }
if steam_get_achievement("WORKSHOP_MASTER") { allach += 1 }
if steam_get_achievement("PUBLISHER") { allach += 1 }
if steam_get_achievement("BOOTLEG_BR") { allach += 1 }
if steam_get_achievement("RACES_MULTI") { allach += 1 }
if steam_get_achievement("CALENDAR_EASY") { allach += 1 }
if steam_get_achievement("CALENDAR_MEDIUM") { allach += 1 }
if steam_get_achievement("CALENDAR_HARD") { allach += 1 }
if steam_get_achievement("SPINNNNN") { allach += 1 }
if steam_get_achievement("FEATURED_LEVEL") { allach += 1 }
if steam_get_achievement("DAILIES") { allach += 1 }
if steam_get_achievement("JACKPOT") { allach += 1 }
}