...
rousr_dissonance_set_small_image("white","Currently White Color")
if room != r_leveleditor { 
	global.totalusepickups += 1
	}
var item = instance_nearest(x+16,y+16,o_whitespiral)
with item {
instance_destroy()
}
audio_play_sound(snd_pickup,5,0);
if global.itempar = 1 { instance_create(x+8,y+8,o_whitepickup) } 
}