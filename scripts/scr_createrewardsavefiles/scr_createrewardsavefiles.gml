function scr_createrewardsavefiles(){
	if global.cheats = 0 {
var month
...
if (file_exists(directory + "Cal" + string(global.calendaryear) + "_" + string(global.calendarmonth) + "_1.sav")) file_delete(directory + "Cal" + string(global.calendaryear) + "_" + string(global.calendarmonth) + "_1.sav");
ini_open(directory + "Cal" + string(global.calendaryear) + "_" + string(global.calendarmonth) + "_1.sav");
