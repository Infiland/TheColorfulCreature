...
draw_text(30,650 - yscroll,QUESTSCOMPLETED + string(global.totalquests))

draw_text_color(30,690 - yscroll,DEATHS,c_yellow,c_orange,c_yellow,c_orange,1)
draw_text(30,710 - yscroll,TOTALDEATHS + string(global.totaldeaths))
draw_text(30,730 - yscroll,BLOCKDEATHS + string(global.totalblockdeaths))
draw_text(30,750 - yscroll,RESTARTDEATHS + string(global.totalrestartdeaths))
draw_text(30,770 - yscroll,SPIKEDEATHS + string(global.totalspikedeaths))
draw_text(30,790 - yscroll,INVSPIKEDEATHS + string(global.totalinvisiblespikedeaths))
draw_text(30,810 - yscroll,VMOVINGSPIKEDEATHS + string(global.totalverticalspikedeaths))
draw_text(30,830 - yscroll,HMOVINGSPIKEDEATHS + string(global.totalhorizontalspikedeaths))
draw_text(30,850 - yscroll,GOLDENSPIKEDEATHS + string(global.totalgoldspikedeaths))
draw_text(30,870 - yscroll,WEIRDSPIKEDEATHS + string(global.totalweirdspikedeaths))
draw_text(30,890 - yscroll,VOIDDEATHS + string(global.totalvoiddeaths))
draw_text(30,910 - yscroll,SETONFIRE + string(global.totalfiredeaths))
draw_text(30,930 - yscroll,LAVADEATHS + string(global.totallavadeaths))
draw_text(30,950 - yscroll,BULLETDEATHS + string(global.totalbulletdeaths))
draw_text(30,970 - yscroll,ROCKETDEATHS + string(global.totalrocketdeaths))
draw_text(30,990 - yscroll,TROOPDEATHS + string(global.totaltroopdeaths))
draw_text(30,1010 - yscroll,DROWNED + string(global.totalwaterdeaths))

draw_text_color(30,1050 - yscroll,AVERAGES,c_yellow,c_orange,c_yellow,c_orange,1)
draw_text(30,1070 - yscroll,AVERAGEDEATHSPERLEVEL + string(global.totaldeaths / global.totallevelcompleted))
draw_text(30,1090 - yscroll,AVERAGETIMEPERLEVEL + string((global.totaltime / 60) / global.totallevelcompleted) + "m")	

draw_text_color(30,1130 - yscroll,PROGRESSION,c_yellow,c_orange,c_yellow,c_orange,1)
draw_text(30,1150 - yscroll,NORMALSKINSUNLOCKED + string(normalskins) + "/" + string(reqnormalskins) + " (" + string(normalskinspercentage) + "%)")
draw_text(30,1170 - yscroll,LEGENDARYSKINSUNLOCKED + string(legskins) + "/" + string(reqlegskins) + " (" + string(legskinspercentage) + "%)")
draw_text(30,1190 - yscroll,HATSACQUIRED + string(allhats) + "/" + string(reqallhats) + " (" + string(hatspercentage) + "%)")
draw_text(30,1210 - yscroll,ITEMSACQUIRED + string(allitems) + "/" + string(reqallitems) + " (" + string(itemspercentage) + "%)")
if global.hardmodeunlock != 0 {
draw_text(30,1230 - yscroll,HARDMODEDIFFICULTIESBEATEN + string(HMprogress) + "/" + string(reqHM) + " (" + string(HMpercentage) + "%)")
} else { draw_text(30,1230 - yscroll,HARDMODEDIFFICULTIESBEATEN + " 0/7") }
draw_text(30,1250 - yscroll,CHALLENGESBEATEN + string(Cprogress) + "/" + string(reqchallenge) + " (" + string(challengepercentage) + "%)")
draw_text(30,1270 - yscroll,PERFECTCHALLENGESBEATEN + string(perfectchallenge) + "/" + string(reqperfectchallenge) + " (" + string(perfectchallengepercentage) + "%)")
draw_text(30,1290 - yscroll,WORLDSCOMPLETED + string(Wprogress) + "/" + string(reqW) + " (" + string(Wpercentage) + "%)")
draw_text(30,1310 - yscroll,TOTALACHIEVEMENTS + string(allach) + "/" + string(reqach) + " (" + string(achpercentage) + "%)")

draw_text_color(30,1350 - yscroll,FULLGAMECOMPLETION + string(gameprogress) + "%",c_yellow,c_orange,c_yellow,c_orange,1)
