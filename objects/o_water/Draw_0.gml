...
if con.shader_enabled shader_set(shd_wave);
    ...
    draw_sprite_ext(s_water,image_index,x,y,image_xscale,image_yscale,0,c_white,1);
shader_reset();
} else { draw_sprite_ext(s_water,image_index,x,y,image_xscale,image_yscale,0,c_white,1) }